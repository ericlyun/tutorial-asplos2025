...
We provide a built Docker image for the tutorial. You can pull it from Docker Hub::
  ...
  docker pull uvxiao/ahs-tutorial:asplos25

Then, you can run the following command to start the container::

  docker run -it --rm uvxiao/ahs-tutorial:asplos25
...
The produced Docker image should be the same as the ``uvxiao/ahs-tutorial:asplos25`` image.
